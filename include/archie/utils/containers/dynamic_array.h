...
namespace utils {
  namespace containers {
    ...
    template <typename Tp, typename Alloc, typename Tag, std::size_t Stock>
    SizeType<dynamic_array<Tp, Alloc, Tag, Stock>> dynamic_array<Tp, Alloc, Tag, Stock>::size()
        const noexcept {
      return impl_.size();
    }
    ...
    template <typename Tp, typename Alloc, typename Tag, std::size_t Stock>
    Reference<dynamic_array<Tp, Alloc, Tag, Stock>> dynamic_array<Tp, Alloc, Tag, Stock>::
    ...
    template <typename Tp, typename Alloc, typename Tag, std::size_t Stock>
    ConstIterator<dynamic_array<Tp, Alloc, Tag, Stock>>
    dynamic_array<Tp, Alloc, Tag, Stock>::cbegin() const noexcept {
      return const_iterator(data());
    }

    template <typename Tp, typename Alloc, typename Tag, std::size_t Stock>
    ConstIterator<dynamic_array<Tp, Alloc, Tag, Stock>>
    dynamic_array<Tp, Alloc, Tag, Stock>::begin() const noexcept {
      return cbegin();
    }
