...
template <typename T, typename U, typename V, typename... W>
enabled<opaque<T, U, W...>, ordered<V>, bool> operator<(opaque<T, U, W...> const& lhs, V const& rhs)
{
  return lhs.value_ < extract(rhs);
}
...
template <typename T, typename U, typename V, typename... W>
enabled<opaque<T, U, W...>, ordered<V>, bool> operator<(V const& lhs, opaque<T, U, W...> const& rhs)
{
